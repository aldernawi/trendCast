            ...
            @foreach($posts as $post)
                <tr>
                    ...
                    <td>
                        ...
                        <!-- نموذج حذف -->
                        <form action="{{ route('posts_freelancer.destroy', $post->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('posts_freelancer.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                    <div class="mb-3">
...
<div class="modal fade" id="addPostModal" tabindex="-1" aria-labelledby="addPostModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('posts_freelancer.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="title" class="form-label">العنوان</label>
                    ...
                    <button type="submit" class="btn btn-outline-white w-100" style="background-color: #d88d5b; color: white;">إضافة</button>
                </form>
            </div>
        </div>
    </div>
