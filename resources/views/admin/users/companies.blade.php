                ...
                <tr>
                    ...
                    <td>
                        @if($user->user_type == 'Company')
                            <span id="status-{{ $user->id }}" class="badge {{ $user->status == 'active' ? 'bg-success' : 'bg-danger' }}" style="cursor: pointer;">
                                ...
                                <form action="{{ route('users.update', $user) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                      <input type="hidden" id="user_type" name="user_type" value="{{ $user->user_type }}">
                                        <div class="col-md-6">
                                            <label for="status" class="form-label form-select">الحالة</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="url" class="form-control" id="company_url" name="company_url" value="{{ $user->company_url }}">
                                    </div>
                                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      <input type="hidden" id="user_type" name="user_type" value="Company">
                        <div class="col-md-6">
                            ...
                            <select class="form-select form-label" id="status" name="status" required>
                    ...
                    <div class="mb-3">
                        <label for="company_url" class="form-label">رابط الشركة</label>
                        <input type="url" class="form-control" id="company_url" name="company_url"  placeholder="ادخل رابط الشركة">
                    </div>
                    <div class="mb-3">
                        <label for="facebook_url" class="form-label">رابط فيسبوك</label>
                    ...
                    <div class="mb-3">
                        <label for="linkedin_url" class="form-label">رابط لينكد إن</label>
                        <input type="url" class="form-control" id="linkedin_url" name="linkedin_url"    placeholder="ادخل رابط لينكد إن">
                    </div>
                    <div class="mb-3">
                        <label for="instagram_url" class="form-label">رابط إنستغرام</label>
...
<script>
    $(document).ready(function() {
        ...
        $('span[id^="status-"]').on('click', function() {
            ...
            var currentStatus = statusElement.text().trim() === 'مفعل' ? 'Active' : 'Inactive';
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    statusElement.text(newStatus === 'Active' ? 'مفعل' : 'غير مفعل');
