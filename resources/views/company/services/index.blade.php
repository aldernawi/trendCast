            ...
            @foreach($userServices as $userService)
                <tr>
                    ...
                    <td>
                        ...
                        <!-- نموذج حذف -->
                        <form action="{{ route('user_services.destroy', $userService) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('user_services.update', $userService) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-3">
...
<div class="modal fade" id="addUserServiceModal" tabindex="-1" aria-labelledby="addUserServiceModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('user_services.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="service_id" class="form-label">اختر الخدمة</label>
                        <select class="form-control" id="service_id" name="service_id" required>
