...
@if (Auth::user()->status == 'active')
                  ...
                  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-4 rotate-caret" id="sidenav-main">
                    ...
                    <div class="collapse navbar-collapse px-0 w-auto " id="sidenav-collapse-main">
                      <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                          <a class="nav-link " href="{{ route('user_services.index') }}">
                              <div class="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
                                  <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>
                              </div>
                        ...
                        <a class="nav-link" href="{{ route('bookings.index') }}">
                            ...
                            <span class="nav-link-text me-1">
                                ...
                                @if(isset($newBookingsCount) && $newBookingsCount > 0)
                                    <span class="badge bg-danger">({{ $newBookingsCount }})</span>
                                @endif
                            </span>
                        </a>
                    </li>
                          ...
                          <li class="nav-item">
                            <a class="nav-link " href="{{ route('company-report') }}">
                              <div class="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
                                <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>
                              </div>
              ...
              .dropdown-menu {
                  ...
                  <!--   Core JS Files   -->
                  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script> <!-- تضمين مكتبة SweetAlert2 -->
